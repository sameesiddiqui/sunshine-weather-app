    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APP_ID_PARAM,"b23a7306687ee2c351739a566a503fbc")
                    .build();
...
//            }
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Intent sentIntent = new Intent(context, SunshineService.class);
            sentIntent.putExtra(LOCATION_QUERY_EXTRA, intent.getStringExtra(SunshineService.LOCATION_QUERY_EXTRA));
